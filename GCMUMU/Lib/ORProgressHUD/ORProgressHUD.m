...
- (void)updateViewWithMessage:(NSString *)message withFont:(UIFont *)font
{
    ...
    CGRect frame = [message boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:font} context:nil];
//    CGSize msgSize = [message sizeWithFont:font constrainedToSize:maxSize];
    CGSize msgSize = frame.size;
